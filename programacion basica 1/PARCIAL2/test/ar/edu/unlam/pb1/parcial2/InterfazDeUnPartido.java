...
public class InterfazDeUnPartido {
	...
	private static void mostrarMenu() {
		...
		System.out.println("10 - Ver resultado");
	...
	private static PartidoDeFutbol determinarAccionARealizar(EquipoDeFutbol[] inscriptosAlTorneo,
		...
		switch(opcionIngresada) {
			...
			case VER_EL_RESUMEN:
				...
				break;
			case 10:
				if(actual.getGanador() !=null) {
					System.out.println(actual.getGanador());
				}else
	...
	private static void agregarNuevoJugador(Scanner teclado, EquipoDeFutbol inscriptos[]) {
		...
		Jugador nuevo2 = new Jugador(numero+1, nombre, edad+1, precio+10);
		inscriptos[equipoSeleccionado].agregarJugador(nuevo2);
		Jugador nuevo3 = new Jugador(numero+1, nombre, edad+1, precio+10);
		inscriptos[equipoSeleccionado].agregarJugador(nuevo3);
		Jugador nuevo4 = new Jugador(numero+1, nombre, edad+1, precio+10);
		inscriptos[equipoSeleccionado].agregarJugador(nuevo4);
		Jugador nuevo5 = new Jugador(numero+1, nombre, edad+1, precio+10);
		inscriptos[equipoSeleccionado].agregarJugador(nuevo5);
