...
public class SegundoParcial {
	...
	public void queSePuedaEmitirUnaPolizaDeVida() {
		...
		Persona conyuge = new Persona("Arturo", 65456232, 2);
	...
	public void queSePuedaEmitirUnaPolizaDeCombinadoFamiliar() {
		...
		Persona asegurado = new Persona("Camila", 45987345, 24);
		Persona hijo = new Persona("Arturo", 65456231, 2);
		Persona hija = new Persona("Maia", 65445232, 4);
	...
	public void queSePuedanAdministrarDistintosTiposDePolizas() {
		...
		libra.agregarPoliza(new PolizaAccidentesPersonales(3, new Persona("Pedro", 455647346, 24), 2000000.0, 5000.0));
		libra.agregarPoliza(new PolizaCombinadoFamiliar(4, new Persona("Natalia", 45987347, 24), 2000000.0, 5000.0));
