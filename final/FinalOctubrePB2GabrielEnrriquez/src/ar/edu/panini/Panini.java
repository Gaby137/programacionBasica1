...
public class Panini {
	...
	public Boolean intercambioDeFiguritas(Final u1, Figurita figuritaAIntercambiar, Final u2) throws FiguritaNoDisponible {
		Boolean intercambiado = false;
		if (this.getListaDeUsuarios().contains(u1) && this.getListaDeUsuarios().contains(u2)) {
